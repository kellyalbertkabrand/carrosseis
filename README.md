# Carrosséis — Kelly Albert

Repositório de **modelos de carrossel** para Instagram (Mentoria Marca com Essência©).
Cada modelo fica em sua própria pasta, com a especificação (`CLAUDE.md`) e, futuramente,
